              ...
              <div className="flex justify-center gap-3">
                {otp.map((digit, index) => (
                  <input
                    ...
                    onPaste={handlePaste}
                    className="w-12 h-14 sm:w-14 sm:h-16 text-center text-2xl font-bold bg-secondary-800 border-2 border-surface-light text-text-primary rounded-lg focus:border-primary-500 focus:ring-2 focus:ring-primary-500/20 transition-all"
                    disabled={loading}
                  />
                ))}
              </div>
